<template>
  <nav v-if="isLoggedIn">
      <v-toolbar app color="#E58123">
       <v-app-bar-nav-icon @click='toggleDrawer'></v-app-bar-nav-icon>
      <v-toolbar-title >
        <span>Capudoy Project</span>
    ...
    <v-btn
     ...
     <v-navigation-drawer app v-model="drawer">
      <router-link to="/aboutme" class="rlink">
        <v-card-text class="abtme"><img class="myimage" src="https://i.postimg.cc/7bnL74c2/elijah1.png" alt="My Picture"> Elijah Capudoy :3</v-card-text>
      </router-link>
...
<script setup>
  ...
  const  items =  ref([
           ...
           { title: 'Result', icon:'mdi-clipboard-clock-outline', path: '/result'},
        ])
