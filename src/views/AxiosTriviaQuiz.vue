  ...
  <body>
    <v-row class="vrow">
        <v-col
            ...
            lg="6"
        >
            <v-card ref="form" class="ma-15" max-width="700" max-height="800" color="#7E4414">
                <v-card-text>
                  <section class="quiz" v-if="!squiz">
                    
                    <center><h1 id="headline">Entertaiment: Japanese Anime & Manga</h1></center>
                    <img id="logo-crown" src="https://i.postimg.cc/9FJX3ZKd/pngwing-com.png" class="height:10px;width:10px;" alt="Quiz" /> 
                  ...
                  <section class="quiz" v-if="!quizCompleted">
                    <img id="logo-crown" src="https://i.postimg.cc/8P8X1YQD/pngkey-com-no-game-no-life-3346073.png" class="height:10px;width:10px;" alt="Quiz" /> 
                    <center><h1 id="headline">Entertaiment: Japanese Anime & Manga</h1></center>
    ...
    methods: {
      async fetchQuestions() {
        ...
        let response = await fetch(
          "https://opentdb.com/api.php?amount=20&category=31&difficulty=medium"
        );
